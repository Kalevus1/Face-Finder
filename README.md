...
## ⬇️ Descargar (versión lista para usar)

No necesitas instalar Python: en la sección **[Releases](../../releases)** de este repositorio
puedes descargar el programa ya compilado, en **dos formatos**:

| Versión | Archivo | Cómo se usa | Ideal si... |
|---------|---------|-------------|-------------|
| 🗂️ **Carpeta** | `FaceFinder_v1.0_carpeta.zip` | Descomprime el `.zip` y ejecuta `FaceFinder.exe` | Quieres que **abra rápido** y estable (recomendada) |
| 📄 **Archivo único** | `FaceFinder_v1.0.exe` | Doble clic directo, sin descomprimir | Prefieres **un solo archivo** (la 1.ª apertura tarda ~15 s) |

> Ambas versiones incluyen todo lo necesario y funcionan sin conexión. Solo para **Windows**.
> Si prefieres ejecutar el código fuente, sigue la instalación de la sección 6.
